        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <Link className="link link-hover"> Rating</Link>
                    <Link className="link link-hover">Review </Link>
                    <Link className="link link-hover">Newsletters</Link>
                </div>
                <div>
                    <span className="footer-title font-serif">About Kitchen</span>
                    <Link className="link link-hover">About us</Link>
                    <Link className="link link-hover">Contact</Link>
                    <Link className="link link-hover">Jobs</Link>
                    <Link className="link link-hover">History</Link>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p className='font-sans font-semibold'>Kh Sultana's Kitchen <br />Providing reliable since 2016</p>
                </div>
