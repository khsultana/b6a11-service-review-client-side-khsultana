...
const ForOrder = () => {
    ...
    const handlePlaceOrder = event => {
        ...
        // if (phone.length > 11) {
        //     alert("Phone Number Should be 11 Char! ")
        // }
        // else {
    ...
    return (
        ...
        <form onSubmit={handlePlaceOrder} >
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                ...
                <input name="phone" type="text" placeholder="Your Phone " className="input input-bordered input-secondary w-full " required />
            ...
            <textarea name='message' className="textarea textarea-error w-full h-80 mt-12" placeholder="Tell Someting About Order"></textarea>
            <input className='btn btn-secondary mb-12' type="submit" value="Place Your Order" />
        </form>
